...
classification_model = load_model('/media/4tbdrive/engines/cs230/models/movenet/classification/stroke_classification_357.keras')
tfjs.converters.save_keras_model(classification_model, "/media/4tbdrive/engines/cs230/models/tfjs/classification/357/")
