...
log_dir = f"logs/{pose_type}/stroke_classification/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
...
print("Model saved as:", f"models/{pose_type}/classification/stroke_classification_{history.epoch[-1]}.keras")
